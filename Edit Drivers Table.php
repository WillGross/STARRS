...
function modifyDriverForm(){
	...
	$modifyForm.="</select></br> Select Information to Edit: <select name=selectInfo><option value=''></option>
					...
					Please Enter a new Value: <input type=text name=newInfo>
...
function addDriverForm(){
	$addForm = "<form id=addDriver method=post>
				...
				Username: <input type=text name=driverUserName>
				Email: <input type=text name=driverEmail>
				Status: <input type=text name=driverStatus>
